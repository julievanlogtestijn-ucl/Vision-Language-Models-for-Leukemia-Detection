...
DATA_CSV =          "/cs/student/projects1/aibh/2024/jvanlogt/miniconda3/dissertation_code/Finetune_BLIP/data/dataset_classification.csv"
...
train_dataset.save_to_disk("train_data_classification")
test_dataset.save_to_disk("test_data_classification")
