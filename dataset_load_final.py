...
DATA_CSV =          "/cs/student/projects1/aibh/2024/jvanlogt/miniconda3/dissertation_code/Finetune_BLIP/data/eindresultaat_dataset.csv"
...
features = Features({
    ...
    'cell_lineage': Value('string'),
    'lineage_label': Value('string'),
    'varied_descriptions': Value('string'),
    'vqa_q1': Value('string'),
    'vqa_a1': Value('string'),
    'vqa_q2': Value('string'),
    'vqa_a2': Value('string'),
...
train_dataset.save_to_disk("eindresultaat_train_data")
test_dataset.save_to_disk("eindresultaat_test_data")
